...
Content shares happen through private channels 84 percent of the time, though this rate ranges from 56 to over 82 percent depending on the specific industry. This behavior creates a massive blind spot for content marketers. You see high direct traffic volumes but cannot prove which articles drive distribution. 
...
```html
<a href="mailto:?subject=Read this guide&body=https://swetrix.com/blog/example-post?utm_source=website-share&utm_medium=dark-social">
  Share via Email
</a>
```
