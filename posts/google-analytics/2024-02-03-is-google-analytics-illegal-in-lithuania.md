...
European Center for Digital Rights has [filed](https://noyb.eu/en/101-complaints-eu-us-transfers-filed) complaints against dozens of companies across the EU for using Google Analytics because it doesn't comply with the GDPR. Three of these companies are located in Lithuania.
...
<ol>
  ...
  <li>
    <a href="#gdpr-in-lithuania">
      Does the GDPR affect Lithuania?
    </a>
  </li>
  <li>
...
<h2 id="gdpr-in-lithuania">
  Does the GDPR affect Lithuania?
</h2>
The General Data Protection Regulation (GDPR) of the European Economic Area (EEA) applies to all 27 EU member countries, including Lithuania, and to any company operating in or targeting the Lithuanian market.
If you use Google Analytics and your websites target audience are Lithuanians - you may be <b>in breach</b> of the GDPR!

However, there are privacy-friendly alternatives to Google Analytics. Swetrix enables the collection of important metrics without the need for gathering any personal data. This ensures <b>GDPR compliance</b>, as the GDPR does not apply to the data processed.

<h2 id="what-is-gdpr-fuss-about">
  GDPR: What's all the fuss about?
</h2>
The General Data Protection Regulation (GDPR) came into effect on 25 May 2018 and now applies to almost every business in the EU. It builds on the existing Data Protection Act of 1996 and places greater emphasis on the handling of personal data. All businesses and organisations must now ensure that personal data is stored securely and protected.
