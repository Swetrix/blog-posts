...
[Swetrix](https://swetrix.com) is a privacy-first, open-source web analytics platform designed for developers who care about user privacy. We provide the insights you need to grow your project without compromising the trust of your community.
...
We don't just talk about open source; we are open source. The entire Swetrix stack is available on [GitHub](https://github.com/swetrix/swetrix). We believe that the tools used to measure the open web should themselves be open and auditable.
...
Ready to secure your project's analytics stack? **[Start your 14-day free trial of Swetrix Cloud today](https://swetrix.com)**, or explore our [open-source repository](https://github.com/swetrix/swetrix) to learn about self-hosting.
