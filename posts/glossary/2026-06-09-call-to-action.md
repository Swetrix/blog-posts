...
| Page type      | CTA examples                                         |
| -------------- | ---------------------------------------------------- |
| SaaS homepage  | Start free trial, View demo, See pricing             |
| Blog post      | Read related guide, Try the product, Join newsletter |
| Pricing page   | Start trial, Contact sales, Compare plans            |
| Ecommerce page | Add to cart, Buy now, Check availability             |
| Documentation  | Copy code, Create account, Open dashboard            |
...
Related terms: [conversion](https://swetrix.com/glossary/conversion), [conversion rate](https://swetrix.com/glossary/conversion-rate), [click-through rate](https://swetrix.com/glossary/click-through-rate), and [landing page](https://swetrix.com/glossary/landing-page).
