...
intro: "Two Romanian companies are under GDPR investigation for using Google Analytics. Learn about the regulatory risks and privacy-friendly alternatives for the Romanian market."
...
seoDescription: "Explore Google Analytics privacy concerns in Romania, the history of GDPR complaints, and privacy-friendly analytics alternatives."
---

European Center for Digital Rights has [filed](https://noyb.eu/en/101-complaints-eu-us-transfers-filed) complaints against dozens of companies across the EU for using Google Analytics because it doesn't comply with the GDPR. Two of these companies are based in Romania.
...
The proposed "Trans-Atlantic Data Privacy Framework" seems to be a repetition of previous unsuccessful agreements. Despite claims of progress, little has changed in US law or the EU's approach, especially regarding FISA 702 surveillance and the protection of non-US individuals' rights. The EU-US negotiations resulted in a one-page agreement in principle that fails to address key privacy concerns. Although the agreement includes cosmetic changes and the renaming of oversight bodies, it lacks meaningful reform, leaving data transfers and privacy rights in a precarious state. Legal challenges to this framework are expected, and its <b>future remains uncertain</b> as it heads back to the Court of Justice.
...
Our service is cookie-less, meaning that we do not collect personal information or track individual users. This allows you to obtain all the necessary analytics insights without compromising privacy. Here's a [live demo](https://swetrix.com/demo) page so you can see for yourself.
