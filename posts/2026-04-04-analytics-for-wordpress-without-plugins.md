...
European courts restrict how you capture and store visitor data. The Schrems II ruling by the European Court of Justice struck down the EU-US Privacy Shield ([Court of Justice of the European Union, 2020](https://curia.europa.eu/jcms/upload/docs/application/pdf/2020-07/cp200091en.pdf)). Following this legal precedent, the French data protection authority (CNIL) determined that exporting Google Analytics traffic data to US servers violates GDPR Chapter V ([CNIL, 2022](https://www.cnil.fr/en/google-analytics-and-data-transfers-how-make-your-analytics-tool-compliant-gdpr)). For the framework adopted in July 2023, the [EDPB’s information note](https://www.edpb.europa.eu/system/files/documents/2023-07/edpb_informationnoteadequacydecisionus_en.pdf) explains the basis for transfers to participating US organisations. Review the applicable transfer mechanism for each analytics provider.

Google’s [consent mode documentation](https://developers.google.com/tag-platform/security/guides/consent) explains how to set default consent states and update them after a visitor makes a choice. Tag behaviour depends on the consent state and implementation. Test accepted and denied states to understand which events your reports include.
